...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-black border-r border-[#1a1a1a] fixed left-0 top-0 z-40",
        className
      )}
      animate={{
      ...
      {...props}
    >
      <LiquidGlass className="w-full h-full bg-transparent border-none shadow-none">
        {children}
      </LiquidGlass>
    </motion.div>
  );
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-14 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-black border-b border-[#1a1a1a] w-full"
        )}
        {...props}
      >
